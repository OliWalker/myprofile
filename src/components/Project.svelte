		...
		<div class="project__text">
			...
			<ul class="textSmall">
				{#each project.techStack as tech}
					<li class="textSecondary tech">{tech}</li>
				{/each}
			</ul>
			{#if project.duties.length > 0}
				<p class="textLarge">Notable Work:</p>
				<ul class="textSmall">
					{#each project.duties as duty}
						<li class="textSecondary">{duty}</li>
					{/each}
				</ul>
			{/if}
		</div>
